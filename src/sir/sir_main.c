...
#define CHECK_MALLOC( TEST ) if( TEST == NULL ) { exit(1); }
...
void L_main() 
{
  ...
  mbedtls_memory_buffer_alloc_init( platform_config.heap_buf, 524288 );
  init_memory(platform_config.heap_buf + 524288, 524288);
