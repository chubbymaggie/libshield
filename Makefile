shared:
	...
	@cc -O2 -shared -fPIC -Wl,-soname,libsir.so -o bin/libsir.so bin/libmem.o bin/test_dhm.o bin/sir_main.o bin/rand.o bin/div.o -nostdlib -Lsrc/sir/crypto/library/ -lmbedcrypto
