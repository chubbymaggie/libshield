shared:
	...
	@cc -O2 -c -Wall -W -Wdeclaration-after-statement -fPIC -fno-stack-protector -nostdlib src/sir/test_dhm.c -Isrc/sir/crypto/include -o bin/test_dhm.o
	@cc -O2 -shared -fPIC -Wl,-soname,libsir.so -o bin/libsir.so bin/libmem.o bin/test_dhm.o bin/sir_main.o bin/rand.o bin/div.o -nostdlib -Lsrc/sir/crypto/library/ -lmbedcrypto -Lsrc/sir/drng -ldrng
