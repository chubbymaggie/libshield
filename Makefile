shared:
	...
	@cc -O2 -shared -fPIC -Wl,-soname,libsir.so -o bin/libsir.so bin/libmem.o bin/sir_dhm.o bin/sir_aes_gcm.o bin/sir_channel.o bin/sir_main.o bin/div.o -nostdlib -Lsrc/sir/crypto/library/ -lmbedcrypto -Lsrc/sir/rand -ldrng
